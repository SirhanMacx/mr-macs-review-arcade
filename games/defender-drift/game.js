...
(function () {
  ...
  function pickQuestion() {
    // MRMAC_QUESTION_VALIDATOR_V1 — defender-drift INLINE_BANK uses {q,choices,correct:idx}
    // shape (not prompt/correctText), so the global validator can't match directly.
    // We retry up to 5× to skip any obviously-broken entries.
    for (var i = 0; i < 5; i++) {
